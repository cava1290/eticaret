        ...
        <td width="500" valign="top">
            <form action="index.php?SK=32" method="post">
                <table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr height ="30">
                        <td colspan="2" valign="top" style="border-bottom: 1px dashed #CCCCCC">Aşağıdan hesabıan giriş yapabilirsin.. </td>
                    </tr>
                    ...
                    <tr height ="30">
                        <td colspan="2" valign="top" align="left"><input type="email" name="EmailAdresi" class="InputAlanları"></td>
                    </tr>

                    <tr height ="30">
                        <td  valign="bottom" align="left">Şifre (*)</td>
                        <td class="AnaMenu"  valign="bottom" align="right"><a href="index.php?SK=37" > Şifremi Unuttum </a></td>
                    </tr>
                    <tr height ="30">
                        <td colspan="2" valign="top" align="left"><input type="password" name="Sıfre" class="InputAlanları"></td>
                    </tr>
                    <tr height ="30">

                    <tr height = "40">
                        <td align="center">
                            <input type="submit" value="Giriş Yap" class="YesilButton">
                        </td>
                    </tr>
                </table>
            </form>

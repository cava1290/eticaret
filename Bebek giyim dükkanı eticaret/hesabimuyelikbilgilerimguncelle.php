            ...
            <td width="500" valign="top">
                <form action="index.php?SK=52" method="post">
                    <table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr height="30">
                            <td colspan="2" valign="top" align="left"><input type="email" name="EmailAdresi" class="InputAlanları" value="<?php echo $EmailAdresi; ?>"></td>
                        </tr>
                        ...
                        <tr height="30">
                            <td colspan="2" valign="top" align="left"><input type="password" name="Sıfre" class="InputAlanları" value="EskiSifre"></td>
                        </tr>

                        <tr height="30">
                            <td colspan="2" valign="bottom" align="left">Şifre Tekrarı (*)</td>
                        </tr>
                        <tr height="30">
                            <td colspan="2" valign="top" align="left"><input type="password" name="SıfreTekrar" class="InputAlanları" value="EskiSifre"></td>
                        </tr>
                        ...
                        <tr height="30">
                            <td colspan="2" valign="top" align="left"><input type="text" name="IsimSoyisim" class="InputAlanları" value="<?php echo $IsimSoyisim; ?>"></td>
                        </tr>
                        ...
                        <tr height="30">
                            <td colspan="2" valign="top" align="left"><input type="text" name="TelefonNumarasi" maxlength="11" class="InputAlanları" value="<?php echo $TelefonNumarasi; ?>"></td>
                        </tr>

                        <tr height="40">
                            <td align="center">
                                <input type="submit" value="Güncelle" class="YesilButton">
                            </td>
                        </tr>
                    </table>
                </form>
